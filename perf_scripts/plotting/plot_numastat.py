...
# add a library path
import sys
sys.path.append("/data/sandeep/git_repo/exec_scripts/plotting")
...
# THis is MB. Convert to GB and save tgeh results.
...
save_array_to_file( f"{directory}/plots/raw/dram_vmrss",dram_usage_data)
save_array_to_file( f"{directory}/plots/raw/avg_dram_vmrss",avg_dram_usage_data)

save_array_to_file( f"{directory}/plots/raw/optane_vmrss",optane_usage_data)
...
save_array_to_file( f"{directory}/plots/raw/dram_tco",dram_tco_data)
save_array_to_file( f"{directory}/plots/raw/optane_tco",optane_tco_daa)
save_array_to_file( f"{directory}/plots/raw/total_tco",total_tco_data)
