...
if args.plot_pdf==1:
    ...
    print("Saving plot to: ", directory + "/plots/vmstat_" + args.metric + ".png")
    plt.savefig(directory + "/plots/vmstat_" + args.metric + ".png")
elif args.plot_pdf==2:
    print("Saving plot to: ", directory + "/plots/vmstat_" + args.metric + ".pdf")
    plt.savefig(directory + "/plots/vmstat_" + args.metric + ".pdf")
else:
